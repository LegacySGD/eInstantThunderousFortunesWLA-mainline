...
public class ThunderousFortunesWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(ThunderousFortunesWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/ThunderousFortunesWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/ThunderousFortunesWLAIW/InitOutcome.xml").getDocumentElement();
